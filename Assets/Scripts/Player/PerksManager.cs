...
public class PerksManager : MonoBehaviour
{
	...
	{
		Buttons[0].interactable = !TimerManager.TimerExsistsNamed("DOUBLE_TIME");
		Buttons[1].interactable = !TimerManager.TimerExsistsNamed("DOUBLE_MONEY");
		Buttons[2].interactable = !TimerManager.TimerExsistsNamed("AUTO_COLLECT");
