...
public class Warehouse : MonoBehaviour
{
	...
	public void SendStuffToShop(bool setupFillTimes = true)
	{
        ...
        Timer timer = TimerManager.CreateTimerWithUI("BackRoomsFiller", truckTravelDelay, new Timer.CustomData(), GameManager.Instance.perksManager.DoubleSpeed ? 2f : 1f, camManager.Camera.WorldToScreenPoint(backroomsT.position), backroomFillSprite);
	...
	private void OnBackroomsContinue(Timer.CustomData data) { truck.ContinueWay(); }
